...
// import { VERSION as rollupVersion } from 'npm:rollup'
const rollupVersion = "3.28.0"
import type {
  AsyncPluginHooks,
  CustomPluginOptions,
  EmittedFile,
...
import { TraceMap, originalPositionFor } from 'npm:@jridgewell/trace-mapping'
import MagicString from 'npm:magic-string'
import type { FSWatcher } from 'npm:chokidar'
import colors from 'npm:picocolors'
import type * as postcss from 'npm:postcss'
import type { ModuleGraph, Plugin, ResolvedConfig } from 'vite'
import { normalizePath } from './utils.ts'
import { arraify, cleanUrl, createPluginHookUtils, generateCodeFrame, isExternalUrl, isObject, numberToPos, unwrapId } from './utils.ts'
