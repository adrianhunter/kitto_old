...
describe('Script', () => {
  ...
  describe('#isDataOut', () => {
    ...
    it('validates that this two part OP_RETURN is standard', () => {
    ...
    it('validates that this 220-byte OP_RETURN is standard', () => {
  ...
  describe('#add and #prepend', () => {
    ...
    it('should add these push data', () => {
      ...
      buf.fill(0)
      Script().add(buf).toString().should.equal(`OP_PUSHDATA4 ${2 ** 16} 0x${buf.toString('hex')}`)
    })
    ...
    it('fails with wrong type', () => {
      const fails = () => new Script().add(true);
  ...
  describe('#buildMultisigOut', () => {
    ...
    it('should fail when number of required signatures is greater than number of pubkeys', () => {
      ...
      expect(() => Script.buildMultisigOut(sortkeys, 4)).to.throw('Number of required signatures must be less than or equal to the number of public keys')
    })
  ...
  describe('#buildDataOut', () => {
    ...
    it('should create script from array of some data', () => {
      const data = Buffer.from('bacacafe0102030405', 'hex');
    ...
    it('should create script from array of some datas', () => {
    ...
    it('should create script from array of lots of data', () => {
      const data1 = Buffer.from('moneybutton.com');
    ...
    it('should create script from an array of strings', () => {
      const data = 'hello world!!!';
      const s = Script.buildDataOut([data, data]);
      should.exist(s)
    ...
    it('should create script from an array of a hex string', () => {
      const hexString = 'abcdef0123456789';
      const s = Script.buildDataOut([hexString], 'hex');
      should.exist(s)
      s.toString().should.equal('OP_RETURN 8 0xabcdef0123456789')
    ...
    it('should create script from an array of hex strings', () => {
      const hexString = 'abcdef0123456789';
  ...
  describe('#getSignatureOperationsCount', () => {
    ...
    it('should handle P2SH-multisig-in scripts from utility', () => {
      ...
      const signature = bsv.crypto.Signature.fromString('30060201FF0201FF');
