...
describe("PrivateKey", () => {
  ...
  describe("instantiation", () => {
    it("should not be able to instantiate private key greater than N", () => {
      expect(() => new PrivateKey(Point.getN())).to.throw(
  ...
  describe("#json/object", () => {
    ...
    it("also accepts an object as argument", () => {
      expect(() => PrivateKey.fromObject(new PrivateKey().toObject())).to.not
        .throw();
    });

    it("also accepts an object as argument", () => {
      expect(() => PrivateKey.fromObject(new PrivateKey().toJSON())).to.not
        .throw();
    });
  });
  ...
  it("creates an address as expected from WIF, livenet", () => {
    ...
    privkey.publicKey.toAddress().toString().should.equal(
      "135bwugFCmhmNU3SeCsJeTqvo5ViymgwZ9",
    );
  });
  ...
  it("creates an address as expected from WIF, testnet", () => {
    ...
    privkey.publicKey.toAddress().toString().should.equal(
      "moiAvLUw16qgrwhFGo1eDnXHC2wPMYiv7Y",
    );
  });
});
