...
import data from "../data/merkleblocks.js";
import transactionVector from "data/tx_creation.json" assert { type: "json" };
...
describe("MerkleBlock", () => {
  ...
  describe("#constructor", () => {
    ...
    it("should not make an empty block", () => {
      (() => new MerkleBlock()).should.throw(
        "Unrecognized argument for MerkleBlock",
      );
    });
  });
