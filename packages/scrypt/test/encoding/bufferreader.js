...
import BufferReader from "bsv/encoding/bufferreader.js";
import BufferWriter from "bsv/encoding/bufferwriter.js";
...
describe("BufferReader", () => {
  ...
  describe("readVarLengthBuffer", () => {
    ...
    it("fails on length too big", () => {
      ...
      const br = new BufferReader(buf);
      br.readVarLengthBuffer.bind(br).should.throw(
  ...
  describe("#readUInt64BEBN", () => {
    ...
    it("should return 2^64", () => {
      ...
      buf.fill(0xff);
      const br = new BufferReader(buf);
      br.readUInt64BEBN().toNumber().should.equal(2 ** 64);
    });
  });
  ...
  describe("#readUInt64LEBN", () => {
    ...
    it("should return 2^30", () => {
      ...
      const br = new BufferReader(buf);
      br.readUInt64LEBN().toNumber().should.equal(2 ** 30);
    });
    ...
    it("should return 2^64", () => {
      ...
      buf.fill(0xff);
      const br = new BufferReader(buf);
      br.readUInt64LEBN().toNumber().should.equal(2 ** 64);
    });
  });
  ...
  describe("#readVarintBuf", () => {
    ...
    it("should read a 9 byte varint", () => {
      const buf = new BufferWriter().writeVarintBN(new BN((2 ** 54).toString()))
        .concat();
      const br = new BufferReader(buf);
  ...
  describe("#readVarintNum", () => {
    ...
    it("should not throw an error on a 9 byte varint not over the javascript uint precision limit", () => {
      const buf = new BufferWriter().writeVarintBN(new BN((2 ** 53).toString()))
        .concat();
      const br = new BufferReader(buf);
      (() => {
        br.readVarintNum();
  ...
  describe("#readVarintBN", () => {
    ...
    it("should read a 9 byte varint", () => {
      ...
      const br = new BufferReader(buf);
      br.readVarintBN().toNumber().should.equal(2 ** 64);
    });
  });
