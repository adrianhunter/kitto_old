...
import bsvErrors from "./errors/index.js";
...
class HDPublicKey {
    ...
    if (arg) {
      if (_.isString(arg) || Buffer.isBuffer(arg)) {
        ...
        if (!error) {
          ...
          Buffer.isBuffer(arg) && !HDPublicKey.getSerializedError(arg.toString())
        ) {
  ...
  static fromHDPrivateKey(hdPrivateKey) {
  ...
  static getSerializedError(data, network) {
    ...
    if (
      version === Network.livenet.xprivkey || version === Network.testnet.xprivkey
    ) {
 ...
 * </ul>
 */
HDPublicKey.prototype.toObject =
  HDPublicKey.prototype.toJSON =
    function toObject() {
      return {
...
HDPublicKey.ChildIndexEnd = HDPublicKey.ChildIndexStart +
  HDPublicKey.ChildIndexSize;
HDPublicKey.ChainCodeStart = HDPublicKey.ChildIndexEnd;
HDPublicKey.ChainCodeEnd = HDPublicKey.ChainCodeStart +
  HDPublicKey.ChainCodeSize;
HDPublicKey.PublicKeyStart = HDPublicKey.ChainCodeEnd;
HDPublicKey.PublicKeyEnd = HDPublicKey.PublicKeyStart +
  HDPublicKey.PublicKeySize;
