...
// let SIGHASH_SINGLE_BUG = Buffer.from(
...
let sighashPreimageForForkId = function (
  transaction,
  sighashType,
  inputNumber,
  subscript,
...
var sighashPreimage = function sighashPreimage(
  ...
  if (
    ...
    return sighashPreimageForForkId(
      transaction,
      sighashType,
      inputNumber,
      subscript,
 ...
 * @namespace Signing
 */
// export { sighashPreimage };
// export { sighash };
// export { sign };
// export { verify };

export default { sighashPreimage, sighash, sign, verify };
