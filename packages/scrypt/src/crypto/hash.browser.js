 ...
 */
export const sha1 = function (buf) {
 ...
 * @returns {Buffer} The hash in the form of a buffer.
 */
export const sha256 = function (buf) {
  $.checkArgument(Buffer.isBuffer(buf));
 ...
 * @returns {Buffer} The hash in the form of a buffer.
 */
export const sha256sha256 = function (buf) {
  $.checkArgument(Buffer.isBuffer(buf));
 ...
 * @returns {Buffer} The hash in the form of a buffer.
 */
export const ripemd160 = function (buf) {
  $.checkArgument(Buffer.isBuffer(buf));
 ...
 * @returns {Buffer} The hash in the form of a buffer.
 */
export const sha256ripemd160 = function (buf) {
  $.checkArgument(Buffer.isBuffer(buf));
 ...
 * @returns {Buffer} The hash in the form of a buffer.
 */
export const sha512 = function (buf) {
  $.checkArgument(Buffer.isBuffer(buf));
 ...
 */
export const hmac = function (hashf, data, key) {
 ...
 * @returns {Buffer} The HMAC in the form of a buffer.
 */
export const sha256hmac = function (data, key) {
 ...
 * @returns {Buffer} The HMAC in the form of a buffer.
 */
export const sha512hmac = function (data, key) {
